...
const ProductDetailsPage = () => {
  ...
  const product =  useMemo(()=>  products.find((product) => product.id === parseInt(productId)) ,[productId,products] )
...
tableArr.push(<tr  >
  ...
  const {images, title, brand, rating, price, discountPercentage, description, 
    warrantyInformation, shippingInformation, availabilityStatus, returnPolicy,
    stock, minimumOrderQuantity, reviews, 
    } = product
  ...
  return (
          ...
          <div className={style.detail_info}>
            ...
            {images.length > 1 ?
              <div className={style.productImages}>
               ...
               { (images[bigImg])?<img src={images[bigImg]} alt={title} />:  setBigImg(0)}
            ...
            <div className={style.buttons}>
                ...
                <button onClick={()=>getPaymentData(productArr)} className={style.buyButton}>Buy</button>
              </div>
            </div>
            ...
            <div className={style.detailsProductInfo}>
              ...
              {brand && (
                <p style={{ color: "#524C42" }}>Brand: {brand}</p>
              )}
             ...
             <div className={style.specificationContainer} >
              ...
              <h2>Dimensions</h2>
              <table className={style.productDetailsTable}>
                  
                  
                  {
                 tableArr.map(data=>data)
                  }
    ...
    { !loading? <div className={style.similarProductsDiv}>
  ...
  return(
    <div className={style.reviewContainer} >
             <div className={style.reviewRating}>
                <p className={rating>2?style.ratingRate: rating == 2? style.ratingIsTwo : style.ratingIsOne}>{rating}&#9734;</p>
                <h3>{rating == 3 && "good" || rating == 4 && "Pretty good" || rating == 5 && "Brilliant" || rating == 2 && "Fair" || rating == 1 && "Not good" }</h3>
              </div>
